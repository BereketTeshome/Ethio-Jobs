    ...
    return (
      <>
        ...
        <div className="not-found-container">
          ...
          <h3>
            {" "}
            <span style={{ color: "red" }}>No</span> result Found for Jobs in{" "}
            <i>
              {" "}
              "{location.split("%20")} for {category} development"
            </i>{" "}
            <button className="goBack" onClick={() => navigate(-1)}>
              {" "}
              <ReplyAllIcon className="go-back-icon" /> Go Back
            </button>
          </h3>
        </div>
      </>
  ...
  return (
    <>
      ...
      <div className="filtered-header">
        <h2>
          Jobs in{" "}
          <span style={{ color: "#2296F0", fontSize: "100%" }}>
            {" "}
            {location.split("%20")}
          </span>
        </h2>
