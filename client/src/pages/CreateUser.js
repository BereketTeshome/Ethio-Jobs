    ...
    <div className='login'>
      ...
      <div className='create-job-container'>
        ...
        <div style={{display:'flex', justifyContent:'center'}}>
          <h3 style={{fontSize:'1.7rem', color:'white'}}><span style={{color:'#011E3D'}}>Create</span> User</h3>
        </div>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <button type='submit' onClick={(e) => handleSubmit(e)} className='register-container-btn' disabled={!(formik.isValid && formik.dirty)}>Create User</button>
            </div>
